...
export default function FicheMemoCandidat({
  open,
  onOpenChange,
  candidatId,
}: FicheMemoCandidatProps) {
              ...
              <div>
                ...
                <div className="flex items-center space-x-4 text-sm text-gray-500 mt-1">
                  ...
                  <span className="flex items-center">
                    ...
                    {candidat?.code_postal} {candidat?.ville || "-"}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-12 gap-4 bg-gray-50 p-4 overflow-auto max-h-[calc(95vh-80px-64px)]">
            ...
            <div className="col-span-3 space-y-4">
              <Card title="Informations">
                <InfoItem
                  ...
                  value={
                    candidat?.date_naissance
                      ? `${dayjs().diff(candidat.date_naissance, "year")} ans`
                      : "-"
                  }
                />
                <InfoItem
                  ...
                  value={
                    candidat?.created_at
                      ? dayjs(candidat.created_at).format("DD/MM/YYYY")
                      : "-"
                  }
                />
                <InfoItem
                ...
                <InfoItem
                  ...
                  label="Véhicule"
                  value={candidat?.vehicule ? "Oui" : "Non"}
                />
              </Card>
            ...
            <div className="col-span-6 space-y-4">
              <Card
                title="Interdictions"
                badge={
                  <Badge className="bg-white text-gray-800 border-gray-800">
                    {interdictions.length} Interdictions
                  </Badge>
                }
              >
                        ...
                        title={
                          <div className="flex items-start justify-between gap-4">
                            ...
                            <div className="shrink-0">
                              {renderSecteurChip(item.secteur)}
                            </div>
                          </div>
                        }
...
function Card({
  ...
  return (
    <div className="bg-white border rounded-lg shadow-sm">
      <div className="px-4 py-3 border-b flex items-center justify-between bg-gray-200 text-gray-800">
