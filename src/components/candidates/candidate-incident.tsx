...
type CandidatIncidentsTabProps = {
  candidatId: string
}

export function CandidatIncidentsTab({ candidatId }: CandidatIncidentsTabProps) {
    ...
    <div className="space-y-6">
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-gray-500">Aucun incident enregistré pour ce candidat</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <CardHeader className="pb-3">
                  <div className="flex justify-between items-center">
                    <CardTitle className="text-base font-semibold">
                      {clients[incident.client_id] || "Client inconnu"}
                    </CardTitle>
